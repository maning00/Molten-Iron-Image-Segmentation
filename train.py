...
parser.add_argument('--crop_height', type=int, default=1000, help='Height of cropped input image to network')
parser.add_argument('--crop_width', type=int, default=1000, help='Width of cropped input image to network')
